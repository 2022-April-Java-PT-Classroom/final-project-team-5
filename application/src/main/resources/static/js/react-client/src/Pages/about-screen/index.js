    ...
    return (
        <div className={style.aboutScreen}>
               <div className = {style.section}>
                ...
                <img className={style.img} src={Dhana} alt='pic' /> 
                ...
                <img className={style.img} src={Jamie} alt='pic' />
                <h2>Jamie Barr</h2>
                ...
                <img className={style.img} src={Adrian} alt='pic' />
                <h2>Adrian Colter</h2>
                
                <p>A jr. full stack developer located in the greater Cleveland area. 
                ...
                <img className={style.img} src={Victor} alt='pic' />
                <h2>Victor Grullon</h2>
                <p>Full stack java developer based in Cleveland, Ohio. Eager to use my excellent communication 
                     and problem solving skills to help make a difference through tech.</p>
                <img className={style.img} src={Adam} alt='pic' />
                <h2>Adam Ackley</h2>
                <p> I am currently enrolled at We Can Code IT to earn a Certificate in Software
                 ...
                 <img className={style.img} src={Serena} alt='pic' />
                 <h2>Serena Howard</h2>
