...
const RacialScreen=()=>{
    ...
    useEffect(() => {
        const fetchNews = async() => {
            ...
            setNewsOne(result.data.articles[11]);
            setNewsTwo(result.data.articles[81]);
            setNewsThree(result.data.articles[35]);
            setNewsFour(result.data.articles[44]);
            setNewsFive(result.data.articles[52]);
            setNewsSix(result.data.articles[61]);
            setNewsSeven(result.data.articles[78]);
            setNewsEight(result.data.articles[84]);
            setNewsNine(result.data.articles[92]);
            setNewsTen(result.data.articles[34]);
